...
class Hiscore:
    ...
    async def fetch(self):
        ...
        self.bounty_hunter_hunter_rank = int(self.scores[24][0])
        self.bounty_hunter_hunter_score = int(self.scores[24][1])
        self.bounty_hunter_rogue_rank = int(self.scores[25][0])
        self.bounty_hunter_rogue_score = int(self.scores[25][1])
        self.lms_rank = int(self.scores[26][0])
        self.lms_score = int(self.scores[26][1])
        ...
        self.kc_abyssal_sire = int(self.scores[35][1])
        self.kc_abyssal_sire_rank = int(self.scores[35][0])
        self.kc_alchemical_hydra = int(self.scores[36][1])
        self.kc_alchemical_hydra_rank = int(self.scores[36][0])
        self.kc_barrows_chest = int(self.scores[37][1])
        self.kc_barrows_chest_rank = int(self.scores[37][0])
        self.kc_bryophyta = int(self.scores[38][1])
        self.kc_bryophyta_rank = int(self.scores[38][0])
        self.kc_callisto = int(self.scores[39][1])
        self.kc_callisto_rank = int(self.scores[39][0])
        self.kc_cerberus = int(self.scores[40][1])
        self.kc_cerberus_rank = int(self.scores[40][0])
        self.kc_chambers_of_xeric = int(self.scores[41][1])
        self.kc_chambers_of_xeric_rank = int(self.scores[41][0])
        self.kc_chambers_of_xeric_challenge = int(self.scores[42][1])
        self.kc_chambers_of_xeric_challenge_rank = int(self.scores[42][0])
        self.kc_chaos_elemental = int(self.scores[43][1])
        self.kc_chaos_elemental_rank = int(self.scores[43][0])
        self.kc_chaos_fanatic = int(self.scores[44][1])
        self.kc_chaos_fanatic_rank = int(self.scores[44][0])
        self.kc_commander_zilyana = int(self.scores[45][1])
        self.kc_commander_zilyana_rank = int(self.scores[45][0])
        self.kc_corporeal_beast = int(self.scores[46][1])
        self.kc_corporeal_beast_rank = int(self.scores[46][0])
        self.kc_crazy_archaeologist = int(self.scores[47][1])
        self.kc_crazy_archaeologist_rank = int(self.scores[47][0])
        self.kc_dagannoth_prime = int(self.scores[48][1])
        self.kc_dagannoth_prime_rank = int(self.scores[48][0])
        self.kc_dagannoth_rex = int(self.scores[49][1])
        self.kc_dagannoth_rex_rank = int(self.scores[49][0])
        self.kc_dagannoth_supreme = int(self.scores[50][1])
        self.kc_dagannoth_supreme_rank = int(self.scores[50][0])
        self.kc_deranged_archaeologist = int(self.scores[51][1])
        self.kc_deranged_archaeologist_rank = int(self.scores[51][0])
        self.kc_general_graardor = int(self.scores[52][1])
        self.kc_general_graardor_rank = int(self.scores[52][0])
        self.kc_giant_mole = int(self.scores[53][1])
        self.kc_giant_mole_rank = int(self.scores[53][0])
        self.kc_grotesque_guardians = int(self.scores[54][1])
        self.kc_grotesque_guardians_rank = int(self.scores[54][0])
        self.kc_hespori = int(self.scores[55][1])
        self.kc_hespori_rank = int(self.scores[55][0])
        self.kc_kalphite_queen = int(self.scores[56][1])
        self.kc_kalphite_queen_rank = int(self.scores[56][0])
        self.kc_king_black_dragon = int(self.scores[57][1])
        self.kc_king_black_dragon_rank = int(self.scores[57][0])
        self.kc_kraken = int(self.scores[58][1])
        self.kc_kraken_rank = int(self.scores[58][0])
        self.kc_kreearra = int(self.scores[59][1])
        self.kc_kreearra_rank = int(self.scores[59][0])
        self.kc_kril_tsutsaroth = int(self.scores[60][1])
        self.kc_kril_tsutsaroth_rank = int(self.scores[60][0])
        self.kc_mimic = int(self.scores[61][1])
        self.kc_mimic_rank = int(self.scores[61][0])
        self.kc_obor = int(self.scores[62][1])
        self.kc_obor_rank = int(self.scores[62][0])
        self.nightmare = int(self.scores[63][0])
        self.nightmare_rank = int(self.scores[63][1])
        self.kc_sarachnis = int(self.scores[64][1])
        self.kc_sarachnis_rank = int(self.scores[64][0])
        self.kc_scorpia = int(self.scores[65][1])
        self.kc_scorpia_rank = int(self.scores[65][0])
        self.kc_skotizo = int(self.scores[66][1])
        self.kc_skotizo_rank = int(self.scores[66][0])
        self.kc_the_gauntlet = int(self.scores[67][1])
        self.kc_the_gauntlet_rank = int(self.scores[67][0])
        self.kc_the_corrupted_gauntlet = int(self.scores[68][1])
        self.kc_the_corrupted_gauntlet_rank = int(self.scores[68][0])
        self.kc_theatre_of_blood = int(self.scores[69][1])
        self.kc_theatre_of_blood_rank = int(self.scores[69][0])
        self.kc_thermonuclear_smoke_devil = int(self.scores[70][1])
        self.kc_thermonuclear_smoke_devil_rank = int(self.scores[70][0])
        self.kc_tzkal_zuk = int(self.scores[71][1])
        self.kc_tzkal_zuk_rank = int(self.scores[71][0])
        self.kc_tztok_jad = int(self.scores[72][1])
        self.kc_tztok_jad_rank = int(self.scores[72][0])
        self.kc_venenatis = int(self.scores[73][1])
        self.kc_venenatis_rank = int(self.scores[73][0])
        self.kc_vetion = int(self.scores[74][1])
        self.kc_vetion_rank = int(self.scores[74][0])
        self.kc_vorkath = int(self.scores[75][1])
        self.kc_vorkath_rank = int(self.scores[75][0])
        self.kc_wintertodt = int(self.scores[76][1])
        self.kc_wintertodt_rank = int(self.scores[76][0])
        self.kc_zalcano = int(self.scores[77][1])
        self.kc_zalcano_rank = int(self.scores[77][0])
        self.kc_zulrah = int(self.scores[78][1])
        self.kc_zulrah_rank = int(self.scores[78][0])
