...
class Hiscore:
    ...
    async def fetch(self):
        ...
        self.kc_nightmare = int(self.scores[63][0])
        self.kc_nightmare_rank = int(self.scores[63][1])
        self.kc_phosanis_nightmare = int(self.scores[64][0])
        self.kc_phosanis_nightmare_rank = int(self.scores[64][1])
        ...
        self.kcs.append(("Nightmare", self.kc_nightmare, self.kc_nightmare_rank))
        self.kcs.append(("Phosani's Nightmare", self.kc_phosanis_nightmare, self.kc_phosanis_nightmare_rank))
